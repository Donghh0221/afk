...
- `/complete` — auto-commit worktree changes (message from changed files), merge into main, cleanup
...
- `/complete` auto-commits uncommitted changes (commit message derived from changed file paths), then rebases onto main + fast-forward merge
